import { act, fireEvent, render, waitFor } from "./helpers/testing-library-vue";
...
describe("Footnote: grandchild VNodeChild not backref (lines 606-612)", () => {
  it("should detect non-backref VNodeChild grandchild as content", () => {
    // li > p > [<strong>, <a backref>]
    // The <strong> is a non-backref VNodeChild grandchild → line 606-612
...
describe("CodeComponent VNodeChild children extraction (line 729)", () => {
  it("should extract code from VNodeChild children with string props.children", async () => {
    // Render Code with data-block and a VNodeChild child that has string children
    ...
    const { container } = render(
      ...
      >
        <PluginContext.Provider value={{}}>
          <Code className="language-javascript" dataBlock="true">
            {codeElement}
          </Code>
