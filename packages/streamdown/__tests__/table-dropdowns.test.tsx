import { act, fireEvent, render } from "./helpers/testing-library-vue";
...
const renderInTableWrapper = (ui: VNodeChild) => {
  return render(
...
describe("TableDownloadButton with format='markdown'", () => {
  ...
  it("should handle default format (fallback to csv)", async () => {
    const { container } = renderInTableWrapper(
