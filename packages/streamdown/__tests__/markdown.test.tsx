...
describe("Markdown Component", () => {
  describe("Basic Rendering", () => {
    ...
    it("should preserve task list classes", () => {
      ...
      expect(items[0]?.className).toContain("task-list-item");
  ...
  describe("Custom Components", () => {
    it("should use custom component for h1", () => {
      const CustomH1 = ({ children }: { children?: VNodeChild }) => (
    ...
    it("should use custom component for paragraph", () => {
      const CustomP = ({ children }: { children?: VNodeChild }) => (
    ...
    it("should use custom component for code", () => {
      const CustomCode = ({ children }: { children?: VNodeChild }) => (
...
> Blockquote`;
  ...
  describe("Integration with Vue rendering", () => {
    it("should generate valid DOM elements", () => {
    ...
    it("should preserve rendered list items", () => {
      const content = "- Item 1\n- Item 2\n- Item 3";
      const { container } = render(<Markdown children={content} />);
      const items = container.querySelectorAll("li");
      expect(items.length).toBe(3);
