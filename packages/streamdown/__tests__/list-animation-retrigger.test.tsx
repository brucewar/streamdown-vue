...
import { act, render } from "./helpers/testing-library-vue";
...
describe("list animation retrigger fix (#410)", () => {
  it("keeps existing list content when a new item appears", async () => {
    ...
    const afterSpans = Array.from(container.querySelectorAll("[data-sd-animate]"));
