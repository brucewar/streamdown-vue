import { fireEvent, render } from "./helpers/testing-library-vue";
...
describe("TableDownloadButton", () => {
  ...
  it("should download CSV by default", async () => {
  ...
  it("should download markdown when format is specified", async () => {
    const onDownload = vi.fn();
...
describe("TableDownloadDropdown", () => {
  ...
  it("should show CSV and Markdown options when open", async () => {
