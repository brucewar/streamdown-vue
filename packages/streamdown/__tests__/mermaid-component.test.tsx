import { act, render, waitFor } from "./helpers/testing-library-vue";
...
describe("Mermaid Component", () => {
  ...
  it("should render in fullscreen mode", async () => {
    ...
    await waitFor(() => {
      ...
      const chart = container.querySelector('[aria-label="Mermaid chart"]');
      expect(panZoom).toBeTruthy();
      expect(chart?.className).toContain("max-h-full");
    });
  });
