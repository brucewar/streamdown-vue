...
import { act } from "./helpers/testing-library-vue";
...
const MermaidTestWrapper = ({ children }: { children: VNodeChild }) => (
...
describe("Mermaid", () => {
  ...
  it("applies custom className", async () => {
    ...
    await act(() => {
      const result = render(
        <MermaidTestWrapper>
          <Mermaid chart="graph TD; A-->B" class="custom-class" />
        </MermaidTestWrapper>
      );
      container = result.container;
    });
  ...
  describe("Fullscreen functionality", () => {
    ...
    it("should open fullscreen modal when fullscreen button is clicked", async () => {
      const { fireEvent } = await import("./helpers/testing-library-vue");
