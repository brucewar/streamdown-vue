import { render, waitFor } from "./helpers/testing-library-vue";
...
describe("Streamdown mode transitions", () => {
  it("should switch from streaming to static mode", async () => {
    const { container, rerender } = render(
      <Streamdown mode="streaming">Hello World</Streamdown>
    );

    await rerender(<Streamdown mode="static">Hello World</Streamdown>);
  ...
  it("should use useTransition in streaming mode for block updates", async () => {
    ...
    await rerender(<Streamdown mode="streaming">First\n\nSecond block</Streamdown>);
  ...
  it("should set displayBlocks directly in non-streaming mode", async () => {
    const { container, rerender } = render(
      <Streamdown mode="static">First</Streamdown>
    );

    await rerender(<Streamdown mode="static">Updated</Streamdown>);
